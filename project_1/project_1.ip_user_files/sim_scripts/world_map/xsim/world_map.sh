...
#
# Generated by Vivado on Thu Dec 10 16:37:02 -0800 2020
...
# Script info
echo -e "world_map.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot world_map xil_defaultlib.world_map xil_defaultlib.glbl -log elaborate.log
}
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./world_map.sh -help\" for more information)\n"
    exit 1
  fi
