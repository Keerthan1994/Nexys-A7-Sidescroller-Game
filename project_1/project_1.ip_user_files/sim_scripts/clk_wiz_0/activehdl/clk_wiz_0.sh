...
#
# Generated by Vivado on Mon Oct 26 13:17:49 -0700 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/RVfpga/proj2-rojobot-prof_brian_test/project_1/project_1.cache/compile_simlib/activehdl"
  fi
