...
HD_PWD='C:/Users/rromano/Documents/GitHub/Nexys-A7-Sidescroller-Game/project_1/project_1.runs/world_map_loop_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log world_map_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source world_map_loop.tcl
